...
Many of these searches use well-modelled signals to compare to the data, which leads to the parameter space having to be finely sampled such that it is sufficiently covered.  
