...
The parameters $w_L$ and $p(M_L)/p(M_G)$ \joe{check its line over signal not noise} show that the sensitivity drops substantially as the values increase. 
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{C3_soap/line_example.pdf}
