...
SOAP searches though narrow-banded time-frequency spectrograms of data and identifies the `most probable track' in frequency through it.  This `most probable track' is then the most probable continuous track in what it otherwise noisy data.  
...
Fig.~\ref{soap:las:osgl_plots} shows an example of the output of the statistic in Eq.~\ref{soap:las:logodds} for different \gls{FFT} powers $F$.
\begin{figure}
\centering
