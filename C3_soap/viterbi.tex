...
Figure \ref{soap:motivation:plot} shows a histogram of a subset of these values.
...
Some work has been done on a variant of the Viterbi algorithm to search for a postmerger remnant of the GW170817 merger \citep{abbott2019SearchGravitational}.
