...
~\chris{You could expand upon this subsection. One thing to address is the
issue that the signal does not last for the entire length of the window. What
could you say about that? You could make the argument that SOAP makes the TF
track far more visible that a spectrogram and other algoritjhms could be
developed to search the vitmaps?}
