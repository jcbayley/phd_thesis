...
Efficiency curves are then generated for each of these runs and the values for the \gls{SNR} at 80\% efficiency are recorded \joe{update to the 95\% eff}. 
Figure \ref{soap:las:optimisation:gaussplot} then shows the 80\% efficiency for each parameter value.
