...
Fig.~\ref{soap:sens:other:gw170817} shows how SOAP identifies a track which follows that of the \gls{BNS} and the Viterbi map shows a clear excess of power where the signal lies.
...
This is an area of work which would benefit from further investigation.
