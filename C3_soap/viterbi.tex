...
The work in Sec.~\ref{viterbi:lineawareamp}, Sec.~\ref{viterbi:las:optimisation}, Sec.~\ref{viterbi:sensfreq} and Sec.~\ref{viterbi:sens:other} which is supplementary material.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\label{viterbi:las:optimisation}Optimisation of Line-aware statistic.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{S6 injections into gapless Gaussian noise and Gaussian noise with gaps}
...
Whilst this optimisation was partially done in Sec.~\ref{results}, with the result in Tab.~\ref{parameters}, this is repeated more completely here.
The parameters were optimised in the range shown in Tab.~\ref{viterbi:las:optimisation:table}.

Fig.~\ref{viterbi:optimisation:gauss} shows the values for the \ac{SNR} at 80\% efficiency for each of the parameter values which were tested, the optimum which is ........ \joe{run test and fill in} 
...
\begin{figure}
    ...
    \caption{When using real S6 data, all four parameters of the search were optimised over on simulations in real data. The plot above shows the \ac{SNR} at 80\% efficiency for each of the parameters where the ranges are in Tab.~\ref{viterbi:las:optimisation:table}. Lower values of \ac{SNR} mean the search is performing better. The red lines show the parameters used in the searches in this section and the sections that follow. Whilst this does not seem optimal, the search does not underperform much when a poor choice of parameters is used. }
...
%%%%%%%%%%%%%%%%%%5
%%%%%%%%%%%%%%%%%%%
\subsection{\label{viterbi:sensfreq}Sensitivity with frequency}
%%%%%%%%%%%%%%%%%%%5
%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%
%%%%%%%%%%%%%%
\subsection{\label{viterbi:sens:other} Searching for non CW sources}
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%
