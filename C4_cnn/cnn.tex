...
In the convolutional neural network case, assuming a filter size of 2$\times$2, one has 5 parameters to vary.  This then outputs am image of 9x9 pixels. \joe{sort out example}
