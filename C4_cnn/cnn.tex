...
When this type of layer is trained, the weights of the filter are updated. The filter should then ideally match the feature which is intended to be extracted from the image.
...
This is a harder challenge for the neural network as it increases the size of the parameter space.
