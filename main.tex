...
\newcommand{\graham}[1]{\textbf{\textcolor{blue}{GRAHAM: #1}}}
...
\acrodef{PEM}[PEM]{physical environment monitor}
\acrodef{CFS}[CFS]{Chandrasekhar, Friedman and Schutz}
\acrodef{SSB}[SSB]{solar system barycenter}
\acrodef{MSU}[MSU]{million standard units}
...
\include{C5_detchar/det_char}

\include{C6_summary/summary}
