...
\newacronym{ETMX}{ETMX}{end test mass X}
\newacronym{ETMY}{ETMY}{end test mass Y}
\newacronym{ITMX}{ITMX}{internal test mass X}
\newacronym{ITMY}{ITMY}{internal test mass Y}
...
\listoffigures
\glsresetall
\include{acknowledgements_declaration}
...
\include{AppendixB/appendixb_nested}
