...
\begin{description}
	...
	\item[5. Generate summary page] Finally the summary pages are built which take all of the bands and puts them in a table. This table can be ordered by the value of the Viterbi statistic, or can be searched for particular frequency bands. These pages then show the plots as in Fig.~\ref{detchar:soap:noiseplot} along with their Viterbi statistic.
\end{description}
