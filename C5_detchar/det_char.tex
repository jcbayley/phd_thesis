...
It is therefore crucial to understand the structure and origin of these lines when performing a search for \gls{GW}, specifically \gls{CW} and stochastic searches \joe{explain why stochastic}.
...
\begin{itemize}
	...
	\item Armadillo was a tool that focusses on the digital control sysyem
