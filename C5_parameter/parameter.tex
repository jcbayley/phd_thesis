...
something about how they are defined/known.}.  We can write the phase evolution from Eq.~\ref{searchcw:model:phase} as
%
\begin{equation}
...
We can estimate the likelihood distribution using a \gls{KDE}
of all our values of $M_i - V_i$. 
The \gls{KDE} is a method to estimate a prpbability density function \joe{here}
~\chris{OK, but that came a bit fast. What is
