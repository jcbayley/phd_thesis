...
The dependence of the likelihood on the \gls{SNR} introduces one more parameter to search over in our
...
The sky area could be reduced by a half by using the antenna response of the detector, this would locate the source to one hemisphere removing one mode from the bi modal sky distribution.
