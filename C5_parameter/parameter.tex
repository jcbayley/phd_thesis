...
2 between 40 and 200. This gives us $\sim 300$
...
similar.~\chris{ To be fancy you could also plot the
...
\begin{figure}[ht]
    ...
    \caption[histogram showing the area contained within 90\% confidence contours]{A histogram is shown~\chris{strange language} of the sky area
