...
time of the observation. Do you address this further on?}. The sum of these two components
...
\end{equation} 
%
where $N$ is the length of the Viterbi track $\bm{V}$. \chris{It's not clear
