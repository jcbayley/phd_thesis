...
This aimed to limit the parameter space for more sensitive analysis such as \joe{are you sure its just this} Einstein@Home \citep{} to further analyse the signal. 
