...
The method described in Sec.~\ref{par_est:bayes} takes in a Viterbi track and returns the five dimensional posterior distribution $p\left(\left\{ \alpha, \delta, f, \dot{f}, \rho \right\} \mid \bm{V}, I \right)$.
